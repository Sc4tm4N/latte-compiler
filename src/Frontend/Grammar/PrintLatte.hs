...
module Frontend.Grammar.PrintLatte where
...
instance Print (TopDef a) where
  prt i e = case e of
    ...
    ClassDef _ id classbodys -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 classbodys, doc (showString "}")])
    ExtendsClassDef _ id1 id2 classbodys -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 classbodys, doc (showString "}")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (ClassBody a) where
  prt i e = case e of
    FunAttr _ fundef -> prPrec i 0 (concatD [prt 0 fundef])
    TypAttr _ type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print (Type a) where
  prt i e = case e of
    ...
    TFun _ type_ types -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 types, doc (showString ")")])
    TTab _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "[]")])
...
instance Print (Expr a) where
  prt i e = case e of
    ...
    ENewClass _ type_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_])
    EAttrFun _ expr id exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id, doc (showString "("), prt 0 exprs, doc (showString ")")])
    EAttrType _ expr id -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id])
