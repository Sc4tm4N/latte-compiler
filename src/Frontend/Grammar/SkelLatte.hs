module Frontend.Grammar.SkelLatte where
...
transTopDef x = case x of
  ...
  ClassDef _ ident classbodys -> failure x
  ExtendsClassDef _ ident1 ident2 classbodys -> failure x
transClassBody :: Show a => ClassBody a -> Result
transClassBody x = case x of
  FunAttr _ fundef -> failure x
  TypAttr _ type_ ident -> failure x
...
transType x = case x of
  ...
  TBool _ -> failure x
  TVoid _ -> failure x
  TFun _ type_ types -> failure x
  TTab _ type_ -> failure x
...
transExpr x = case x of
  ...
  ENewClass _ type_ -> failure x
  EAttrFun _ expr ident exprs -> failure x
  EAttrType _ expr ident -> failure x
